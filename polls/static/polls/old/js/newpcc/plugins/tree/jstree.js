 ...
 */
	...
	$.jstree.defaults.core = {
		...
		/**
		 * Should the nodes opened-closed state be able to change by click node's jstree-ocl . Defaults to `false`
		 * @name $.jstree.defaults.core.lock_states
		 */
		lock_states : false
	};
		...
		bind : function () {
			...
			this.element
				...
				.on("click.jstree", ".jstree-ocl", $.proxy(function (e) {
						if(this.settings.core.lock_states==false) {
